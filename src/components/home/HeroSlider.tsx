...
export function HeroSlider({ banners = [] }: HeroSliderProps) {
  ...
  if (!total) {
    return (
      <div className="flex aspect-[16/7] items-center justify-center rounded-3xl border border-borderSoft bg-surface text-sm font-bold text-textSecondary md:aspect-[929/556]">
