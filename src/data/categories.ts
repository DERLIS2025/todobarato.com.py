...
export const categories: Category[] = [
 { name: "Electrónica", slug: "electronica", icon: "⚡", description: "Accesorios, audio, gadgets y tecnología útil.", color: "from-primary to-cta" },
 ...
 { name: "Hogar", slug: "hogar", icon: "🏠", description: "Orden, limpieza, deco y confort diario.", color: "from-primaryDark to-cta" },
 ...
 { name: "Temporada", slug: "temporada", icon: "☀️", description: "Selección especial para cada época del año.", color: "from-primaryDark to-cta" }
];
